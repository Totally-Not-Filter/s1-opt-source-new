...
KosPlus_module_queue		ds.b 6*Max_PLC		; 6 bytes per entry, first longword is source location and next word is VRAM destination
...
v_ssscroll_buffer	= KosPlus_decomp_buffer+$100
