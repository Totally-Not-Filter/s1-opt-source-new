...
v_snddriver_ram.v_soundqueue0	=	Clone_Driver_RAM+SMPS_RAM.variables.queue.v_playsnd1
v_snddriver_ram.v_soundqueue1	=	Clone_Driver_RAM+SMPS_RAM.variables.queue.v_playsnd2
v_snddriver_ram.v_soundqueue2	=	Clone_Driver_RAM+SMPS_RAM.variables.queue.v_playsnd3
