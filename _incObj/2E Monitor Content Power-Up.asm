...
Pow_ChkShoes:
		...
		move.w	#bgm_Speedup,(v_snddriver_ram.v_soundqueue0).w
		rts
; ===========================================================================
...
Pow_ChkShield:
		...
		move.w	#sfx_Shield,(v_snddriver_ram.v_soundqueue1).w
		rts
; ===========================================================================
...
Pow_ChkInvinc:
		...
		move.w	#bgm_Invincible,(v_snddriver_ram.v_soundqueue0).w
...
Pow_RingSound:
		move.w	#sfx_Ring,(v_snddriver_ram.v_soundqueue1).w
