...
; ===========================================================================
Pow_Types:
		dc.w Pow_ChkEggman-Pow_Types
		dc.w Pow_ChkEggman-Pow_Types
		dc.w Pow_ChkSonic-Pow_Types
		dc.w Pow_ChkShoes-Pow_Types
		dc.w Pow_ChkShield-Pow_Types
		dc.w Pow_ChkInvinc-Pow_Types
		dc.w Pow_ChkRings-Pow_Types
		dc.w Pow_ChkS-Pow_Types
; ===========================================================================
...
Pow_ChkShoes:
		...
		move.w	#(60*20)-1,(v_player+shoetime).w	; time limit for the power-up
		move.w	#$C00,(v_sonspeedmax).w ; change Sonic's top speed
		move.w	#$18,(v_sonspeedacc).w	; change Sonic's acceleration
		move.w	#$80,(v_sonspeeddec).w	; change Sonic's deceleration
		move.b	#bgm_Speedup,(v_snddriver_ram.v_soundqueue0).w
		rts
; ===========================================================================
...
Pow_ChkShield:
		...
		move.b	#sfx_Shield,(v_snddriver_ram.v_soundqueue1).w
		rts
; ===========================================================================

Pow_ChkInvinc:
		move.b	#1,(v_invinc).w	; make Sonic invincible
		move.w	#(60*20)-1,(v_player+invtime).w ; time limit for the power-up
		move.l	#ShieldItem,(v_starsobj1).w ; load stars object ($3801)
		move.b	#1,(v_starsobj1+obAnim).w
		move.l	#ShieldItem,(v_starsobj2).w ; load stars object ($3802)
		move.b	#2,(v_starsobj2+obAnim).w
		move.l	#ShieldItem,(v_starsobj3).w ; load stars object ($3803)
		move.b	#3,(v_starsobj3+obAnim).w
		move.l	#ShieldItem,(v_starsobj4).w ; load stars object ($3804)
		...
		move.b	#bgm_Invincible,(v_snddriver_ram.v_soundqueue0).w
...
Pow_RingSound:
		move.b	#sfx_Ring,(v_snddriver_ram.v_soundqueue1).w
...
Pow_Delete:	; Routine 4
		...
		bmi.s	.delete	; delete after half a second
		jmp	(DisplaySprite).w
.delete:
		jmp	(DeleteObject).w