...
ESon_MakeEmeralds:
		...
		addq.b	#2,ob2ndRout(a0)
		move.w	#1,obAnim(a0)
		move.l	#EndChaos,(v_endemeralds).w ; load chaos emeralds objects
...
Obj87_LookUp:	; Routine 6
		cmpi.w	#$2000,(v_endemeralds+echa_radius).w
		bne.s	locret_5480
...
Obj87_MakeLogo:	; Routine $C
		...
		move.b	#2,obAnim(a0)
		move.l	#EndSTH,(v_endlogo).w ; load "SONIC THE HEDGEHOG" object
