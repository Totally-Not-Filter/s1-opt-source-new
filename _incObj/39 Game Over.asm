...
Over_ChkPLC:	; Routine 0
		tst.w	(KosPlus_modules_left).w ; are the pattern load cues empty?
...
Over_SetWait:
		move.w	#720-1,obTimeFrame(a0) ; set time delay to 12 seconds
		addq.b	#2,obRoutine(a0)
		jmp	(DisplaySprite).w
; ===========================================================================
...
Over_Wait:	; Routine 4
		...
		btst	#0,obFrame(a0)
		bne.s	Over_Display
		subq.w	#1,obTimeFrame(a0)	; has time delay reached zero?
		bmi.s	Over_ChgMode	; if yes, branch
		jmp	(DisplaySprite).w
; ===========================================================================
