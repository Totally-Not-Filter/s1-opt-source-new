...
Card_LoadConfig:
		lea	Card_ConData(pc),a3
		lsl.w	#4,d0
		adda.w	d0,a3
		lea	Card_ItemData(pc),a2
		moveq	#3,d1

Card_Loop:
		_move.l	#TitleCard,obID(a1)
...
Card_MakeSprite:
		...
		move.w	#0*$80,obPriority(a1)
		move.w	#60-1,obTimeFrame(a1) ; set time delay to 1 second
...
Card_Wait:	; Routine 4/6
		subq.w	#1,obTimeFrame(a0)	; is time remaining zero?
		bmi.s	Card_ChkPos2	; if yes, branch
		jmp	(DisplaySprite).w
; ===========================================================================
