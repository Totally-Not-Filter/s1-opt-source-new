...
.chkinvincible:
		...
		bpl.s	.chkshoes	; if no time remains, branch
...
.islabyrinth:
		...
		move.l	a0,(v_sonicbubbles+objoff_40).w
...
Sonic_JumpAngle:
		...
		bcc.s	.applyangle	; if the angle's still below 0, dont clear the angle.
		moveq	#0,d0
		bra.s	.applyangle
