...
Debug_ShowItem:
		...
		add.w	d0,d0
		add.w	d1,d0
		move.l	4(a2,d0.w),obMap(a0) ; load mappings for item
		move.w	8(a2,d0.w),obGfx(a0) ; load VRAM setting for item
		move.b	(a2,d0.w),obFrame(a0) ; load frame number for item
		rts
