...
Sign_Touch:	; Routine 2
		...
		move.w	#sfx_Signpost,(v_snddriver_ram.v_soundqueue1).w
...
Sign_SonicRun:	; Routine 6
	if debugbuild
		...
		tst.l	(v_player+obID).w	; Check if Sonic's object has been deleted (because he entered the giant ring)
		beq.s	loc_EC86
...
.hastimebonus:
		...
		move.w	#bgm_GotThrough,(v_snddriver_ram.v_soundqueue0).w
