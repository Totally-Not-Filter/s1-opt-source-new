...
loc_6EB0:
		...
		bsr.w	FindFreeObj
		bne.s	loc_6ED0
		_move.l	#BossGreenHill,obID(a1) ; load GHZ boss object
		move.w	#boss_ghz_x+$100,obX(a1)
		move.w	#boss_ghz_y-$80,obY(a1)

loc_6ED0:
		move.b	#bgm_Boss,(v_snddriver_ram.v_soundqueue0).w
...
;loc_6F28:
		...
		bsr.w	FindFreeObj
		bne.s	loc_6F4A
		_move.l	#BossLabyrinth,obID(a1) ; load LZ boss object
...
DLE_MZ3boss:
		...
		bsr.w	FindFreeObj
		bne.s	loc_70D0
		_move.l	#BossMarble,obID(a1) ; load MZ boss object
