...
; ===========================================================================
Osc_Baselines:	dc.w %0000000001111100	; oscillation direction bitfield
		dc.w $80, 0
		dc.w $80, 0
		dc.w $80, 0
		dc.w $80, 0
...
OscillateNumInit:
		...
		lea	Osc_Baselines(pc),a2
;		moveq	#$20,d1

;.loop:
	rept bytesToLcnt(Osc_Baselines_End-Osc_Baselines)
		move.l	(a2)+,(a1)+	; copy baseline values to RAM
	endm
	if bytesToLcnt(Osc_Baselines_End-Osc_Baselines)&2
