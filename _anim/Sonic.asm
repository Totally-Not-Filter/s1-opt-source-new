...
ptr_Wait_Ending:	dc.w SonAni_Wait_Ending-Ani_Sonic

SonAni_Walk:	dc.b $FF, fr_Walk13, fr_Walk14,	fr_Walk15, fr_Walk16, fr_Walk11, fr_Walk12, afEnd
		even
SonAni_Run:	dc.b $FF,  fr_Run11,  fr_Run12,  fr_Run13,  fr_Run14,     afEnd
		even
SonAni_Roll:	dc.b $FE,  fr_Roll1,  fr_Roll2,  fr_Roll3,  fr_Roll4,  fr_Roll5,     afEnd
		even
SonAni_Roll2:	dc.b $FE,  fr_Roll1,  fr_Roll2,  fr_Roll5,  fr_Roll3,  fr_Roll4,  fr_Roll5, afEnd
		even
SonAni_Push:	dc.b $FD,  fr_Push1,  fr_Push2,  fr_Push3,  fr_Push4,     afEnd
		even
...
SonAni_Float4:	dc.b 3,	fr_Float1, afChange, id_Walk
		even
SonAni_Wait_Ending:	dc.b $17, fr_Wait2, fr_Wait3, afBack, 2
		even
...
id_Wait_Ending:	equ (ptr_Wait_Ending-Ani_Sonic)/2	; $1F
